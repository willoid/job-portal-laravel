    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <form action="{{ route('job-offers.index') }}" method="GET" class="flex flex-wrap gap-4">
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    @auth
                                        ...
                                        @endif
                                    @else
                                        <a href="{{ route('login') }}" class="bg-blue-500 hover:bg-blue-700 text-white text-sm font-bold py-1 px-3 rounded">
                                            Login to Apply
                                        </a>
                                    @endauth
                                </div>
            ...
            @else
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-center">
                        <p class="text-gray-500 text-lg">No job offers available yet.</p>
